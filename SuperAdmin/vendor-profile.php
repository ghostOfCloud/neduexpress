                    ...
                    <div class="well profile">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4 text-center">
                                <figure>
                                    <img src="../File Manager/woman-1.jpg" alt="" class="img-circle img-responsive">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <ul class="dropdown-menu text-left" role="menu">
                                    ...
                                    <li><a href="#"><span class="fa fa-list pull-right"></span> Add or remove a product  </a></li>
                                    <li class="divider"></li>
                                    <li><a href="#"><span class="fa fa-edit pull-right"></span>Edit Profile</a></li>
                                    <li class="divider"></li>
                                    <li><a href="#" class="btn " role="button"> Disable Profile </a></li>
                                </ul>
                                </div>
                            </div>
                        </div>
