		...
		<div class="wrapper d-flex align-items-stretch">
	      ...
	      <div id="content" class="p-4 p-md-5 pt-5">
	        ...
	        <div class="mycontainhide" id="storeItems">
	        	<div >
	        		<h4 style="display: inline-flex; border-bottom: 2px solid #F58634"><em>Items on high demand</em></h4>
	        	</div>
	        	...
	        	<div class="container recomm-img mt-4">
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-6">
							<div class="product-order-body-img">
								<a href="items-details.html">
									<img src="../images/product_img/portfolio-9.jpg" class="img-fluid high-de-img">
								</a>
							</div>
						</div>
